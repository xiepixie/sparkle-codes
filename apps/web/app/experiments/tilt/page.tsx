    ...
    <div className="min-h-screen bg-background p-12 transition-colors duration-500">
      ...
      <header className="space-y-4 mb-20 max-w-2xl">
        ...
        <p className="text-muted-foreground leading-relaxed text-lg">
          Benchmarking the finalized "Starry Night" Dual-Preset system. 
          Focusing on the balance between physical stability and atmospheric depth.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-sm font-mono text-primary/80 uppercase tracking-[0.2em] font-bold">Industrial Physics</h2>
            <code className="px-2 py-1 rounded bg-secondary text-[10px] font-mono">industrial</code>
          </div>
          <TiltWrapper variant="industrial" className="h-[500px]">
            <div className="h-full flex flex-col justify-end space-y-6">
              <h3 className="text-3xl font-bold tracking-tight">Industrial Material</h3>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                The standard for high-end technical interfaces. Provides a heavy, physical feel resembling precision-cut glass with moderate translucency.
              </p>
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-sm font-mono text-primary uppercase tracking-[0.2em] font-bold">Atmospheric Depth</h2>
            <code className="px-2 py-1 rounded bg-primary/10 text-primary text-[10px] font-mono border border-primary/20">nebula</code>
          </div>
          <TiltWrapper variant="nebula" className="h-[500px]">
            <div className="h-full flex flex-col justify-end space-y-6">
              <h3 className="text-3xl font-bold tracking-tight">Nebula Surface</h3>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Designed for immersive hero sections and storytelling. Creates an optical illusion of vast internal depth, drawing the user into the interface.
              </p>
