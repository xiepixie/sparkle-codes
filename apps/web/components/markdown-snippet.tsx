...
import { escapeRegExp, renderMarkdownSnippet } from "@/lib/markdown-utils";
			...
			<span className={cn("markdown-snippet", className)}>
				{parts.map((part, i) =>
					part.toLowerCase() === query.toLowerCase() ? (
						<mark
							key={i}
							className="search-hit font-semibold bg-primary/20 text-primary underline decoration-primary/30 underline-offset-2"
